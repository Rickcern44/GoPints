...
Admin content pages (forms, tables/lists, buttons, status states) render as part of one unified dark instrument-panel product with the kiosk display, instead of a separate light admin theme or generic Tailwind defaults.
